      ...
      <div class="col-lg"> 
        <div> 
          <h1 class="body-heading-text" style="padding-bottom: 2rem;"> 
            Me In 3 
              <hr width="50%" style="border-top: .8rem solid #FD4D0C; left: 50%; transform: translate(50%, 0%);"> 
            </h1> 
          </div>      
        </div> 
      </div> 
    <div class="row">  
      <div class="col-lg" style="margin-bottom:2rem"> 
        ...
        <div class="card-body" style="background-color: #F3F7D4;"> 
          <div class="card-text">    
            <img src="./indeximg.png" style="width: 15rem; height: auto; position: relative; left: 50%; top: 50%; transform: translate(-50%, 0%); filter: drop-shadow(0 0 .1rem rgb(203, 228, 50));"> 
          </div> 
        </div> 
      </div> 
      <div class="col-lg" style="margin-bottom:2rem"> 
